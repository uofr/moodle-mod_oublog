...
class post_undeleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has undeleted the post with id
    ...
    public static function get_name() {
        return get_string('event:postundeleted', 'mod_oublog');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'oublog', 'undelete post', $logurl,
